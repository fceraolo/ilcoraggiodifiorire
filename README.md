...
Statico su GitHub Pages. Da abilitare in **Settings → Pages → Source: Deploy from a branch → `main` / `/ (root)`**.

Dominio proprio non ancora acquistato: nel frattempo il sito è raggiungibile all'URL di GitHub Pages.
